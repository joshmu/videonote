  ...
  return (
    <div className="container max-w-2xl px-4 pt-4 mx-auto">
      ...
      <div className="space-y-4">
        <p>
          Your privacy is important to us. It is VideoNote's policy to respect your privacy
          regarding any information we may collect from you across our website,{" "}
          <a href="https://videonote.app" className="underline text-themeAccent text-bold">
            https://videonote.app
          </a>
