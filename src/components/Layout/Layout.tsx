 ...
 * @modified Friday, 11th December 2020 9:43:50 am
...
const metaData: { [key: string]: string } = {
  ...
  keywords: "videonote, video, notetaking, todo, josh mu, developer, notes, review, app, timestamp",
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen overflow-hidden font-sans antialiased transition-colors duration-300 ease-in-out debug-screens">
        <main>
          <div className="flex flex-col w-full min-h-screen overflow-hidden">{children}</div>
        </main>
      </div>
    </>
  );
