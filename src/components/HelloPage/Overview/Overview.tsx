          ...
          <div className="ml-8 md:ml-4">
            ...
            <Reveal>
              <p className="tracking-wide">
                A fast and easy workflow to review video content. Utilising a variety of intuitive
                keyboard shortcuts, seamless sharing of projects with a minimal design to keep you
